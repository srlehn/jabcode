...
// Pt returns a PointF with the given coordinates, mirroring image.Pt.
func Pt(x, y float64) PointF { return PointF{X: x, Y: y} }
...
// PerspectiveTransform returns the transform mapping a symbol's module grid
