...
// average out.
func sampleSymbolFootprint(bm *core.Bitmap, pt core.Perspective, side image.Point, modW, modH float64) *core.Bitmap {
...
func sampleSymbolCentre(bm *core.Bitmap, pt core.Perspective, side image.Point) *core.Bitmap {
