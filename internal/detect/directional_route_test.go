...
// foldDirection is never reached: this scanner returns hits rather than leaving
// anything resident, which is the arm these tests cover.
func (f *fakeDirScanner) foldDirection(finderDirSweep, bool) (*finderDirQuad, error) {
	return nil, nil
}

// foldRow is never reached either, for the same reason.
func (f *fakeDirScanner) foldRow(int, int, bool) (*finderDirQuad, error) {
	return nil, nil
}

func (f *fakeDirScanner) foldRowVertical(int, int, int, bool) (*finderDirQuad, error) {
	return nil, nil
}
